...
if ( $posts ) : ?>
  ...
  <ol class="tribe-list-widget text-center px-0">
    <?php
    ...
    foreach ( $posts as $post ) :
      ...
      <li class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
        ...
        <div class="tribe-event-duration text-white mb-3">
  ...
  <p class="tribe-events-widget-link text-center">
    <a class="text-white" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'View All %s', 'the-events-calendar' ), $events_label_plural ); ?></a>
  </p>
