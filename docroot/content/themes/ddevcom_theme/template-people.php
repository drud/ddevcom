            ...
            <div class="card mb-2">
              <div class="card-body">
                <img class="rounded-circle"
                  src="<?= get_avatar_url($team_member->data->ID) ?>"
                  alt="<?= $team_member->data->display_name; ?>">
                <div class="d-inline-block">
                  <span class="d-block ml-2"></span> <?= $team_member->data->display_name; ?>
                  <p class="small">
                    <a href="<?= get_author_posts_url($team_member->data->ID); ?>"
                      class="btn btn-sm btn-link">View Posts</a>
                  </p>
                </div>
