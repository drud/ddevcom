<?php
/**
 * ACF Extensions register: Post Formats Select
 *
 * @package     Schema
...
if( !class_exists('schema_acf_field_post_formats_select') ) :

class schema_acf_field_post_formats_select extends acf_field
{
/*
	*  __construct
	*
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Post Formats Select', 'schema-premium');
    ...
    */
    ...
    {
        $args 			= apply_filters( 'schema_acf_field_post_formats_select/get_post_formats_args', 'post-formats' );
        $post_formats 	= get_theme_support($args);
		$output 		= array();
        ...
        return apply_filters( 'schema_acf_field_post_formats_select_choices', $output );
    }
	
}

// create field
new schema_acf_field_post_formats_select( $this->settings );
