<?php
/**
 * ACF Extensions register: Post Type Select
 *
 * @package     Schema
...
if( !class_exists('schema_acf_field_post_type_select') ) :

class schema_acf_field_post_type_select extends acf_field
{
/*
	*  __construct
	*
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Post Types Select', 'schema-premium');
	...
	*/
    ...
    private function post_type_options() {
        ...
        $args 		= apply_filters( 'schema_acf_field_post_type_select/get_post_types_args', array( 'public' => true ) );
        $post_types = get_post_types($args, 'objects');
		$output 	= array();
		
		// Unset post types
		unset($post_types['schema']);
        ...
        return apply_filters( 'schema_acf_field_post_type_select_choices', $output );
    }
	
}

// create field
new schema_acf_field_post_type_select( $this->settings );
