...
function schema_wp_options_page() {
	...
	<div class="wrap <?php echo 'wrap-' . $active_tab; ?>">
        <h1 class="wp-heading-inline"><?php echo SCHEMAPREMIUM_PLUGINNAME . ' <span style="font-size:12px;">Ver '.SCHEMAPREMIUM_VERSION.'</span>'; ?></h1>
		<h1 class="nav-tab-wrapper">
            ...
            <a class="button-primary schema_wiz_btn" href="<?php echo esc_url( admin_url( 'admin.php?page=schema-setup' ) ); ?>"><?php _e( 'Quick Configuration Wizard', 'schema-premium' ); ?></a>
