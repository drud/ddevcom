...
class Schema_WP_Setup_Wizard {
    ...
    public function admin_menus() {
        add_dashboard_page( __('Schema Setup', 'schema-premium'), __('Schema Setup Wizard', 'schema-premium'), 'manage_options', 'schema-setup', '' );
    }
    ...
    public function setup_wizard_header() {
        ...
        <head>
			...
			<style type="text/css">
				...
				.wc-setup-content .wc-setup-next-steps ul .setup-product a:hover {
                    background: #5b6cc7 !important;
                    border-color: #5b6cc7 !important;
                    box-shadow: inset 0 1px 0 rgba(255,255,255,.25),0 1px 0 #5b6cc7;
                }
                .wc-setup .wc-setup-actions .button-primary,
        ...
        <body class="wc-setup wp-core-ui">
            <?php $badge_url = SCHEMAPREMIUM_PLUGIN_URL . 'assets/images/schema-badge.png'; ?>
    ...
    public function setup_wizard_footer() {
        ?>
            <?php if ( 'next_steps' === $this->step ) : ?>
                <a class="wc-return-to-dashboard" href="<?php echo esc_url( admin_url() ); ?>"><?php _e( 'Return to the WordPress Dashboard', 'schema-premium' ); ?></a>
            <?php endif; ?>
            </body>
    ...
    public function schema_setup_introduction() {
        ?>
        <h1><?php _e( 'Welcome to Schema!', 'schema-premium' ); ?></h1>
        <p><?php _e( 'Thank you for choosing Schema to power your website! This quick setup wizard will help you configure the basic settings. <strong>It’s completely optional and shouldn’t take longer than two minutes.</strong>', 'schema-premium' ); ?></p>
        <p><?php _e( 'No time right now? If you don’t want to go through the wizard, you can skip and return to the WordPress dashboard. Come back anytime if you change your mind!', 'schema-premium' ); ?></p>
        <p class="wc-setup-actions step">
            ...
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=schema' ) ); ?>" class="button button-large"><?php _e( 'Not right now', 'schema-premium' ); ?></a>
        </p>
        <?php
    }
    ...
    public function schema_setup_site_type() {
        ?>
        <h1><?php _e( 'Site Type', 'schema-premium' ); ?></h1>
        
        <p><?php _e( 'What is your site about?', 'schema-premium' ); ?></p>
        
        <p class="description"><?php _e( 'This information can help us to prioritize future additions to our plugin for specific types of sites', 'schema-premium' ); ?>.</p>

        <form method="post">
            <table class="form-table">
                <tr>
                	<th scope="row"><label for="site_type"><?php //_e( 'This Website Represent', 'schema-premium' ); ?></label></th>
            ...
            <p class="wc-setup-actions step">
                ...
                <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>" class="button button-large button-next"><?php _e( 'Skip this step', 'schema-premium' ); ?></a>
    ...
    public function schema_setup_general() {
        ?>
        <h1><?php _e( 'Person or Organization', 'schema-premium' ); ?></h1>
        
        <p><?php _e( 'Does your site represent a Person or Organization?', 'schema-premium' ); ?></p>
        
        <p class="description"><?php _e( 'This information will be used in Google\'s Knowledge Graph Card, the big block of information you see on the right side of the search results.', 'schema-premium' ); ?></p>

        <form method="post">
            <table class="form-table">
                <tr>
                	<th scope="row"><label for="organization_or_person"><?php _e( 'This Website Represent', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_radio_callback( array(
						'id' => 'organization_or_person',
						'name' => __( 'Organization or Person?', 'schema-premium' ),
						'desc' => '',
						'type' => 'radio',
						'options' => array(
                ...
                <tr class="organization_or_person">
                	<th scope="row"><label for="name"><?php _e( 'Name', 'schema-premium' ); ?></label></th>
                ...
                <tr class="organization-logo">
                    <th scope="row"><label for="logo"><?php _e( 'Organization Logo', 'schema-premium' ); ?></label></th>
                    <td> 
                    <?php
   ...
   /**
    ...
    public function schema_setup_social_profiles() {
        ...
        ?>
        <h1><?php _e( 'Social Profiles', 'schema-premium' ); ?></h1>
        
        <p><?php _e( 'Provide your social profiles information to a Google Knowledge panel.', 'schema-premium' ); ?></p>
        
        <p class="description"><?php _e( 'Knowledge panels prominently display your social profile information in some Google Search results.', 'schema-premium' ); ?></p>

        <form method="post">
            <table class="form-table">
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'Facebook', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'facebook',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'Twitter', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'twitter',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'Google+', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'google',
						'name' => __( 'Google+', 'schema-premium' ),
						'desc' => '',
						'type' => 'text',
						'std' => '',
						'placeholder' => 'https://',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'Instagram', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'instagram',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'YouTube', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'youtube',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'LinkedIn', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'linkedin',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'Myspace', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'myspace',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'Pinterest', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'pinterest',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'SoundCloud', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'soundcloud',
                ...
                <tr>
                	<th scope="row"><label for="name"><?php _e( 'Tumblr', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_text_callback( array(
						'id' => 'tumblr',
    ...
    public function schema_setup_schemas() {
        ?>
        <h1><?php _e( 'Mark Up Your Content', 'schema-premium' ); ?></h1>
        
        <p><?php _e( 'Automatically, add additional schema.org markups to your website content.', 'schema-premium' ); ?></p>
        
        <form method="post">
            <table class="form-table">
            	<tr class="organization-logo">
                    <th scope="row"><label for="logo"><?php _e( 'Publisher Logo', 'schema-premium' ); ?></label></th>
                    <td> 
                    <?php
                         schema_wp_wiz_image_upload_callback( array(
							'id' => 'publisher_logo',
                ...
                <tr>
                	<th scope="row"><label for="about_page"><?php _e( 'About Page', 'schema-premium' ); ?></label></th>
                ...
                <tr>
                	<th scope="row"><label for="contact_page"><?php _e( 'Contact Page', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_wiz_post_select_callback( array(
							'id' => 'contact_page',
                ...
                <tr>
                	<th scope="row"><label for="breadcrumbs_enable"><?php _e( 'Breadcrumbs', 'schema-premium' ); ?></label></th>
                ...
                <tr>
                	<th scope="row"><label for="comments_enable"><?php _e( 'Comments', 'schema-premium' ); ?></label></th>
                    <td><?php schema_wp_checkbox_callback( array(
							'id' => 'comments_enable',
    ...
    public function schema_setup_ready() {
        ?>
        <h1><?php _e( 'You\'ve done it!', 'schema-premium' ); ?></h1>
		
        <p><?php _e( 'Schema will now take care of all the needed technical optimization of your site content.', 'schema-premium' ); ?></b>
        
         <p><?php _e( 'You can change settings from', 'schema-premium' ); ?> <a href="<?php echo esc_url( admin_url( 'admin.php?page=schema' ) ); ?>"><?php _e( 'here', 'schema-premium' ); ?></a>, or check plugin <a href="https://schema.press/docs-premium/" target="_blank">documentation</a>.</b>
        
        <div class="wc-setup-next-steps">
            <div class="wc-setup-next-steps-first">
                <h2><?php _e( 'Next Step', 'schema-premium' ); ?></h2>
                <ul>
                    <li class="setup-product"><a class="button button-primary button-large" href="<?php echo esc_url( admin_url( 'edit.php?post_type=schema' ) ); ?>"><?php _e( 'Configure Your Schema Types!', 'schema-premium' ); ?></a></li>
                </ul>
            </div>
        </div>
        <?php
...
function schema_wp_wiz_text_callback( $args ) {
	...
	$html     = '<input type="text" class="' . sanitize_html_class( $size ) . '-text" id="schema_wp_settings[' . schema_premium_sanitize_key( $args['id'] ) . ']" ' . $name . ' value="' . esc_attr( stripslashes( $value ) ) . '" placeholder="' . $args['placeholder'] . '" ' . $readonly . '/>';
...
function schema_wp_wiz_select_callback($args) {
	...
	$html = '<select class="wc-enhanced-select" id="schema_wp_settings[' . schema_premium_sanitize_key( $args['id'] ) . ']" name="schema_wp_settings[' . esc_attr( $args['id'] ) . ']" ' . $chosen . 'data-placeholder="' . esc_html( $placeholder ) . '" />';
...
function schema_wp_wiz_image_upload_callback( $args ) {
	...
	$size = ( isset( $args['size'] ) && ! is_null( $args['size'] ) ) ? $args['size'] : 'regular';
	$html = '<input type="text" class="' . sanitize_html_class( $size ) . '-text" style="width:initial" id="schema_wp_settings[' . schema_premium_sanitize_key( $args['id'] ) . ']" name="schema_wp_settings[' . esc_attr( $args['id'] ) . ']" value="' . esc_attr( stripslashes( $value ) ) . '"/>';
	$html .= '<span>&nbsp;<input type="button" class="schema_wp_settings_upload_button button-secondary" style="width:initial" value="' . __( 'Select Image', 'schema-premium' ) . '"/></span>';
...
function schema_wp_wiz_checkbox_callback( $args ) {
	...
	if ( isset( $args['class_field'] ) ) {
		$class_field = 'class="' . schema_premium_sanitize_key( $args['class_field'] ) . ' wc-wizard-shipping-method-enable"';
	} else {
	...
	$html    .= '<input ' . $class_field . 'id="schema_wp_settings[' . schema_premium_sanitize_key( $args['id'] ) . ']" type="checkbox"' . $name . ' value="1" ' . $checked . '/>';
...
function schema_wp_wiz_radio_callback( $args ) {
	...
	foreach ( $args['options'] as $key => $option ) :
		...
		$html .= '<input class="schema-wizard-radio" name="schema_wp_settings[' . schema_premium_sanitize_key( $args['id'] ) . ']" id="schema_wp_settings[' . schema_premium_sanitize_key( $args['id'] ) . '][' . schema_premium_sanitize_key( $key ) . ']" type="radio" value="' . schema_premium_sanitize_key( $key ) . '" ' . checked(true, $checked, false) . '/>&nbsp;';
