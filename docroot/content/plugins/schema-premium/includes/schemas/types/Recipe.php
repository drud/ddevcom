	...
	class Schema_WP_Recipe extends Schema_WP_HowTo {
		...
		*/
		public function schema_output( $post_id = null ) {
			...
			$schema['image'] = isset($properties['images']) ? $properties['images']['image_id'] : schema_premium_get_property_images_new_custom_field( $post->ID, self::type() );
		...
		*/
		public function schema_output_filter( $schema ) {
			...
			unset($schema['nutrition_calories']);
