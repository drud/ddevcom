<?php
/**
 * @package Schema Premium - Class Schema Contact Page
 * @category Core
	...
	class Schema_WP_ContactPage {
		...
		*/
		public function output_no_markup( $schema ) {
			...
			$page_id = schema_wp_get_option( 'contact_page' );
		...
		*/
		public function output_markup() {
			...
			$enabled = apply_filters( 'schema_wp_output_ContactPage_enabled', true );
				if ( ! $enabled )
					return;
			...
			if ( is_singular() ) {
				...
				do_action( 'schema_wp_action_ContactPage' );
		...
		*/
		public function get_markup() {
			...
			return apply_filters( 'schema_singular_output_ContactPage', $schema );
		}
		...
		*/
		public function schema_output( $post_id = null ) {
			...
			return apply_filters( 'schema_output_ContactPage', $schema );
		}
	}
	
	new Schema_WP_ContactPage();
