...
Hummingbird is built with ease-of-use in mind: it makes your WordPress site faster, but it’s also fast to set up. You can scan your site and implement recommended changes in one-click, getting a fast site in mere minutes. Watch the video above if you need convincing ;)
